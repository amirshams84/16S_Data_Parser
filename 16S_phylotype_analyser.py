...
def main(argv):
	...
	main_file.add_argument("--phylotype", help="Phylotype file", required=True)
	main_file.add_argument("--taxlevel", help="taxonomy level on of [species, genus, family", required=True)
	main_file.add_argument("--design", help="design file", required=True)
	main_file.add_argument("--jslib", help="javascript library", required=True)
	main_file.add_argument("--outputdir", help="output directory", required=True)
	main_file.add_argument("--execdir", help="executables_directory", required=True)
	...
	beta.add_argument("--remove_sample_file", help="list of samples to remove", required=True)
	beta.add_argument("--keep_sample_file", help="list of samples to keep", required=True)
	beta.add_argument("--normalize", help="Normalizing using totalgroup method", required=True)
	...
	jslib_list = ['jquery-2.2.3.min.js', 'jquery.tablesorter.js', 'plotly-latest.min.js', 'bootstrap.css', 'bootstrap.min.js', 'tether.min.js', 'fontawesome.min.js']
